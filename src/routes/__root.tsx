...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EduMind AI is a multi-agent AI platform for personalized learning. Tutors, planners, quizzes and career coaches — all in one place." },
      { property: "og:title", content: "EduMind AI — Learn Smarter with Multi-Agent AI" },
      { property: "og:description", content: "A multi-agent AI platform for personalized learning." },
